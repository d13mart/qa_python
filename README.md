...
| `test_get_books_for_children` | `get_books_for_children` | Книги с возрастным рейтингом не попадают в список для детей (параметризация) |
...
- `test_get_books_for_children` — жанры с и без возрастного рейтинга
